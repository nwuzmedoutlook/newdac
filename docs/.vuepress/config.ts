...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "NWUzmed's world",
      description: 'CO2等技术文章。',
    }
  },
  // base: '/newdac/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyrightInfo:
        'NWUzmed | <a href="https://github.com/nwuzmedoutlook/newdac/blob/main/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
