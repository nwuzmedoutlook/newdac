...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    indexImg: {
      ...
      desc: ["弘毅厚重，笃志而体。", "及余饰之方壮兮，周流观乎上下。", "沐甚雨，栉疾风。", "我姑酌彼兕觥，维以不永伤。", ],  // 多个描述，如果填写则覆盖 config.js 的 description，不填写默认读取 config.js 的 description，descFade 为 true 生效
      ...
      bubbleNum: 50,   // 气泡的个数，bubble 为 true 生效，默认 200 个
    },    
