...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyrightInfo:
        'NWUzmed | <a href="https://github.com/nwuzmedoutlook/newdac/blob/main/LICENSE" target="_blank">MIT License</a> | <a href="https://icp.gov.moe/?keyword=20232425" target="_blank">萌ICP备20232425号</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
