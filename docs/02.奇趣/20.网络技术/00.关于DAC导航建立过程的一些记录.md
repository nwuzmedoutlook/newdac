...
#### 社群分享
通过在知乎、微信（公众号、群聊、朋友圈）、QQ（群聊、空间）、B站、微博、贴吧、Github及一些论坛上分享或评论增加网站曝光度。

### 网站改版

建立网站过程中，遇到一个有着相似想法的同学——尔康，原本想着以我收集的站点为基础，在他的服务器上使用WordPress中的一为主题重新搭建导航网站，但后来因为我们都忙于学业，逐渐停止了内容更新。
